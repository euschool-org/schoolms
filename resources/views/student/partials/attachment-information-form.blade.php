        ...
        @foreach($student->attachments as $attachment)
            <tr>
                ...
                <td class="border px-4 py-2">
                    <a href="{{ Storage::disk('spaces')->url('attachments/' . $attachment->filename) }}" class="text-blue-500 hover:text-blue-700" target="_blank">
                        {{ $attachment->filename }}
                    </a>
                </td>
                ...
                <td class="border px-4 py-2">
                    <div class="flex justify-center space-x-4">
                        <a href="{{ route('attachment.download', $attachment->filename) }}"
