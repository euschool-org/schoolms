<form action="{{ route('student.update', $student->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6 ">
    ...
    <div class="col-span-1">
        ...
        <select id="contract_end_date" name="contract_end_date" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="yearly_payment" name="yearly_payment" value="{{ old('yearly_payment', $student->yearly_payment ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('yearly_payment')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="monthly_payment" name="monthly_payment" value="{{ old('monthly_payment', $student->yearly_payment/10 ?? '') }}" disabled class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('yearly_payment')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="currency" name="currency" value="{{ old('currency', $student->currency ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('currency')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="parent_account" name="parent_account" value="{{ old('parent_account', $student->parent_account ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="income_account" name="income_account" value="{{ old('income_account', $student->income_account ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="payment_quantity" name="payment_quantity" value="{{ old('payment_quantity', $student->payment_quantity ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('payment_type')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="custom_discount" name="custom_discount" value="{{ old('custom_discount', $student->custom_discount ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
    ...
    <div class="col-span-1">
        ...
        <input type="email" id="parent_mail" name="parent_mail" value="{{ old('parent_mail', $student->parent_mail ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('parent_mail')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="col-span-1">
        ...
        <input type="text" id="parent_number" name="parent_number" value="{{ old('parent_number', $student->parent_number ?? '') }}" required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        @error('parent_number')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
    </div>
